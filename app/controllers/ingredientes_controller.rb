class IngredientesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ingrediente.save
        format.html { redirect_to @ingrediente, notice: 'Se ha añadido el ingrediente a la base de datos.' }
  ...
  def update
    respond_to do |format|
      if @ingrediente.update(ingrediente_params)
        format.html { redirect_to @ingrediente, notice: 'Se ha modificado el ingrediente.' }
  ...
  def destroy
    @ingrediente.destroy
    respond_to do |format|
      format.html { redirect_to ingredientes_url, notice: 'El ingrediente ha sido eliminado.' }
  ...
  private
    ...
    def ingrediente_params
      params.require(:ingrediente).permit(:ing_nombre)
    end
end
